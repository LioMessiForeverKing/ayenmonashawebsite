...
/**
 * Item in *Biography → Default → Primary → Links*
 */
export interface BiographySliceDefaultPrimaryLinksItem {
	/**
	 * link field in *Biography → Default → Primary → Links*
	 *
	 * - **Field Type**: Link
	 * - **Placeholder**: *None*
	 * - **API ID Path**: biography.default.primary.links[].link
	 * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
	 */
	link: prismic.LinkField;
}
...
export interface BiographySliceDefaultPrimary {
	...
	/**
	 * Links field in *Biography → Default → Primary*
	 *
	 * - **Field Type**: Group
	 * - **Placeholder**: *None*
	 * - **API ID Path**: biography.default.primary.links[]
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	links: prismic.GroupField<Simplify<BiographySliceDefaultPrimaryLinksItem>>;
}
...
declare module '@prismicio/client' {
	...
	namespace Content {
		export type {
			...
			AllDocumentTypes,
			BiographySlice,
			BiographySliceDefaultPrimaryLinksItem,
